...
The assistant analyzes ATM and key strikes across near-term expirations, summarizes Greeks profile
```
...
The assistant evaluates current IV environment, selects optimal bullish strategies, provides specific setups
```
...
The assistant computes expected move, reviews historical earnings reactions, recommends earnings strategy
```
...
The assistant provides full IV analysis: IVR, IVP, term structure, skew, HV comparison
```
