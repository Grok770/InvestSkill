...
## v1.11.0 — 2026-09-24 18:35 UTC

| Field         | Value |
|---------------|-------|
| Version       | `1.11.0` |
| Commit        | `1c5e857` |
| Deployed at   | 2026-09-24 18:35 UTC |
| Skills        | 24 |
| Release       | [GitHub Release](https://github.com/Grok770/InvestSkill/releases/tag/v1.11.0) |
| CI run        | [Actions run](https://github.com/Grok770/InvestSkill/actions/runs/36042338288) |
...
| Artifact | Purpose |
|----------|---------|
| `invest-skill-marketplace-1.11.0.tar.gz` | Full marketplace package |
| `us-stock-analysis-1.11.0.tar.gz` | Claude Code plugin only |
| `cursor-rules-1.11.0.mdc` | Cursor rules file |
| `gemini-prompts-1.11.0.tar.gz` | Gemini CLI prompts |
| `checksums.txt` | SHA256 checksums |
| `*-RELEASE-NOTES.md` | Platform-specific guides |

---

## v1.11.0 — 2026-07-27 02:22 UTC

| Field         | Value |
|---------------|-------|
| Version       | `1.11.0` |
| Commit        | `d105e3f` |
| Deployed at   | 2026-07-27 02:22 UTC |
| Skills        | 24 |
| Release       | [GitHub Release](https://github.com/yennanliu/InvestSkill/releases/tag/v1.11.0) |
| CI run        | [Actions run](https://github.com/yennanliu/InvestSkill/actions/runs/30232021660) |
...
## v1.10.1 — 2026-07-21 23:49 UTC

| Field         | Value |
|---------------|-------|
| Version       | `1.10.1` |
| Commit        | `a5688c9` |
| Deployed at   | 2026-07-21 23:49 UTC |
| Skills        | 24 |
| Release       | [GitHub Release](https://github.com/yennanliu/InvestSkill/releases/tag/v1.10.1) |
| CI run        | [Actions run](https://github.com/yennanliu/InvestSkill/actions/runs/29878362457) |
...
| Artifact | Purpose |
|----------|---------|
| `invest-skill-marketplace-1.10.1.tar.gz` | Full marketplace package |
| `us-stock-analysis-1.10.1.tar.gz` | Claude Code plugin only |
| `cursor-rules-1.10.1.mdc` | Cursor rules file |
| `gemini-prompts-1.10.1.tar.gz` | Gemini CLI prompts |
| `checksums.txt` | SHA256 checksums |
| `*-RELEASE-NOTES.md` | Platform-specific guides |

---

## v1.10.0 — 2026-07-12 02:53 UTC

| Field         | Value |
|---------------|-------|
| Version       | `1.10.0` |
| Commit        | `076b8c9` |
| Deployed at   | 2026-07-12 02:53 UTC |
| Skills        | 24 |
| Release       | [GitHub Release](https://github.com/yennanliu/InvestSkill/releases/tag/v1.10.0) |
| CI run        | [Actions run](https://github.com/yennanliu/InvestSkill/actions/runs/29177430158) |
...
| Artifact | Purpose |
|----------|---------|
| `invest-skill-marketplace-1.10.0.tar.gz` | Full marketplace package |
| `us-stock-analysis-1.10.0.tar.gz` | Claude Code plugin only |
| `cursor-rules-1.10.0.mdc` | Cursor rules file |
| `gemini-prompts-1.10.0.tar.gz` | Gemini CLI prompts |
| `checksums.txt` | SHA256 checksums |
| `*-RELEASE-NOTES.md` | Platform-specific guides |

---

## v1.9.0 — 2026-07-05 01:42 UTC

| Field         | Value |
|---------------|-------|
| Version       | `1.9.0` |
| Commit        | `430a1b0` |
| Deployed at   | 2026-07-05 01:42 UTC |
| Skills        | 24 |
| Release       | [GitHub Release](https://github.com/yennanliu/InvestSkill/releases/tag/v1.9.0) |
| CI run        | [Actions run](https://github.com/yennanliu/InvestSkill/actions/runs/28725967479) |
...
| Artifact | Purpose |
|----------|---------|
| `invest-skill-marketplace-1.9.0.tar.gz` | Full marketplace package |
| `us-stock-analysis-1.9.0.tar.gz` | Claude Code plugin only |
| `cursor-rules-1.9.0.mdc` | Cursor rules file |
| `gemini-prompts-1.9.0.tar.gz` | Gemini CLI prompts |
| `checksums.txt` | SHA256 checksums |
| `*-RELEASE-NOTES.md` | Platform-specific guides |
