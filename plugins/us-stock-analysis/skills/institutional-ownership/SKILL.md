...
Claude retrieves latest 13F data and analyzes recent changes
```
...
Claude focuses on specific institutional holders' activity
```
...
Claude analyzes provided institutional holdings data
```
